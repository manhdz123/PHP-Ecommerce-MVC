        ...
        <div class="row">
            <div class="col-sm-12 padding-right">
                <div class="features_items"><!--features_items-->
                    ...
                    <?php foreach ($dataProductsLimitByName as $value){?>
                    <div class="col-sm-4">
            ...
            <div class="pagination-area">
                <?php
                if($page >1 && $page >1){
                    echo '<a href ="product_controller.php?action=products&name_product='.$value['name_product'].'&cat_id='.$value['category_id'].'&page='.($page-1).'">Prev</a> ';
                }
                 //lap khoang giua
                for($i=1 ;$i<=$total_page; $i++) {
                    ...
                    if ($i == $page) {
                        ...
                        echo '<a href="product_controller.php?action=products&name_product='.$value['name_product'].'&cat_id='.$value['category_id'].'&page='.$i.'">'.$i.'</a>  ';
                    }
                }if($page <$total_page && $total_page >1){
                    echo '<a href="product_controller.php?action=products&name_product='.$value['name_product'].'&cat_id='.$value['category_id'].'&page='.($page+1).'">Next</a>  ';
                }
                ?>
            </div>
        </div>
